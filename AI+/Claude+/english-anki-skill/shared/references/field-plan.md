...
| Picture                    | up to two `<img src="filename">` images of the word/sense: an Openverse photo, then an Iconify icon | Claude    | Find/verify/store both + `--no-pictures`: `shared/references/picture-procedure.md`                  |
