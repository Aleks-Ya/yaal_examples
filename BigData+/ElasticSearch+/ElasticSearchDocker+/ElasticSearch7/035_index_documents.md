...
{ "title": "Oracle"}
{ "index": { "_index": "'"$PEOPLE_INDEX_NAME"'", "_type": "'"$COMPANIES_TYPE_NAME"'", "_id": "2" } }
{ "title": "Google"}
{ "index": { "_index": "'"$PEOPLE_INDEX_NAME"'", "_type": "'"$COMPANIES_TYPE_NAME"'", "_id": "3" } }
{ "title": "Yandex"}
'

curl -XPUT $ES_URL/_bulk?pretty -d '
{ "index": { "_index": "'"$PEOPLE_INDEX_NAME"'", "_type": "'"$PERSONS_TYPE_NAME"'", "_id": "1" } }
{ "name": "John",  "age": 30, "email": "john@mail.ru", "companyId": "1"}
{ "index": { "_index": "'"$PEOPLE_INDEX_NAME"'", "_type": "'"$PERSONS_TYPE_NAME"'", "_id": "2" } }
{ "name": "Mary",  "age": 25, "email": "mary@mail.ru", "companyId": "1"}
{ "index": { "_index": "'"$PEOPLE_INDEX_NAME"'", "_type": "'"$PERSONS_TYPE_NAME"'", "_id": "3" } }
{ "name": "Simon",  "age": 40, "email": "simon@mail.ru", "companyId": "2"}
{ "index": { "_index": "'"$PEOPLE_INDEX_NAME"'", "_type": "'"$PERSONS_TYPE_NAME"'", "_id": "4" } }
