...
public class AppIT extends AbstractBootYarnClusterTests {
	...
	public void testApp() throws Exception {
		String[] args = new String[] {
				"--spring.yarn.client.files[0]=file:target/gs-yarn-basic-dist/gs-yarn-basic-container-1.jar",
				"--spring.yarn.client.files[1]=file:target/gs-yarn-basic-dist/gs-yarn-basic-appmaster-1.jar" };
