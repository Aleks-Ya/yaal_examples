 ...
 */
public class MixSyncAndAsyncProducer extends BaseTest {
    ...
    public void produce() {
        ...
        try (Producer<String, String> producer = createProducer(new StringSerializer(), new StringSerializer(), new Properties());
             SyncAsyncProducer<String, String> asyncProducer = new SyncAsyncProducer<>(producer)) {
            for (Message message : messages) {
                ProducerRecord<String, String> record = new ProducerRecord<>(topic, message.text);
