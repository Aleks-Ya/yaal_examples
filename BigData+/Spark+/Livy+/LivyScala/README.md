...
Submit:
1. Build JAR: `sbt clean assembly`
2. Submit the app: run main class `livy.Main`

3. Run Spark Standalone cluster from `BigData+/Spark+/SparkDocker+/SparkStandaloneDocker`
4. Choose Java 8: `sdk use java 8.0.302-open`
