...
Delete an object from a Workspace: `databricks workspace delete /initScripts/init.py`
Delete a folder in a Workspace: `databricks workspace delete --recursive /MyWorkspace/dir1`
