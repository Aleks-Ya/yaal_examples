...
# Deploy: `cdk deploy MinimalOpenSearchDomainStack219 --profile acc3`
# Destroy: `cdk destroy MinimalOpenSearchDomainStack219 --profile acc3`
class MinimalOpenSearchDomainStack219(Stack):

    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        super().__init__(scope, construct_id, **kwargs)

        domain_name_param: CfnParameter = CfnParameter(self, "domainName", type="String", default="domain219")
