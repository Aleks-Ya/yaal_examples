...
class GptUiApplicationTest extends BaseGptUiTest {
    ...
    private void sendFirstQuestion() {
        ...
        gptApi.put("has grammatical mistakes", "Correctness answer 1", ofMillis(500)).put("a short response", "Short answer 1", ofMillis(1000)).put("a detailed response", "Long answer 1", ofMillis(1500));
    ...
    private void sendSecondQuestion() {
        ...
        gptApi.put("has grammatical mistakes", "Correctness answer 2", ofMillis(500)).put("a short response", "Short answer 2", ofMillis(1000)).put("a detailed response", "Long answer 2", ofMillis(1500));
        verifyWebViewBody(getQuestionCorrectnessWebView(), EXP_CORRECTNESS_HTML_BODY_1);
        verifyWebViewBody(getShortAnswerWebView(), EXP_SHORT_HTML_BODY_1);
        verifyWebViewBody(getLongAnswerWebView(), EXP_LONG_HTML_BODY_1);
        clickOn(getQuestionSendButton());
