...
public class TestingData {
    ...
    public static class I1 {
        public static final String THEME_TITLE = "Theme 1";
        public static final ThemeId THEME_ID = new ThemeId(1L);
        public static final Theme THEME = new Theme(THEME_ID, THEME_TITLE);
        ...
        public static final Interaction INTERACTION = new Interaction(new InteractionId(1L), InteractionType.QUESTION,
                THEME_TITLE, THEME_ID, QUESTION, Map.of(
    ...
    public static class I2 {
        public static final String THEME_TITLE = "Theme 2";
    ...
    public static class I3 {
        public static final String THEME_TITLE = "Theme 3";
