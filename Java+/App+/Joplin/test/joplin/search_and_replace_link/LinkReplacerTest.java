    ...
    void replace() {
        ...
        try (var sqliteService = new SqliteService(dbFile)) {
            ...
            assertThat(replacements).containsExactlyInAnyOrder(
                    new LinkReplacement(new Link(id, "[Joplin link    1   ](:/db65929324925ccbfa789f95cdd293ba)",
                            "Joplin link    1   ", ":/db65929324925ccbfa789f95cdd293ba"),
                            "Joplin link 1", ":/db65929324925ccbfa789f95cdd293ba"),
                    new LinkReplacement(new Link(id, "[WinSCP](:/da4added37344f07a5ff2b9b2e1fdef3)",
                            "WinSCP", ":/da4added37344f07a5ff2b9b2e1fdef3"),
                            "WinSCP", ":/da4added37344f07a5ff2b9b2e1fdef3"),
                    new LinkReplacement(new Link(id, "[Русская ссылка 1](:/ddc9f19456f64ade383ecdd76cf5b90d)",
                            "Русская ссылка 1", ":/ddc9f19456f64ade383ecdd76cf5b90d"),
                            "Русская ссылка 1", ":/ddc9f19456f64ade383ecdd76cf5b90d"),
                    new LinkReplacement(new Link(id, "[](https://winscp.net)", "",
                            "https://winscp.net"), "", "https://winscp.net"),
                    new LinkReplacement(new Link(id, "[](evernote:///view/48821034/s241/5aa9d098-6c4c-4367-8358-77815b98774d/5aa9d098-6c4c-4367-8358-77815b98774d/)", "",
