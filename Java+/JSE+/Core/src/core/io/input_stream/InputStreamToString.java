...
public class InputStreamToString {
	...
	public void byBufferedReader1() throws IOException {
		...
		Assert.assertThat(str, Matchers.equalTo(CONTENT));
	}
	...
	public void byInputStreamReader() throws IOException {
		...
		Assert.assertThat(result.toString(), Matchers.equalTo(CONTENT));
	}
	...
	public void byBufferedReader2() throws IOException {
		...
		Assert.assertThat(result.toString(), Matchers.equalTo(expected));
	}
}
