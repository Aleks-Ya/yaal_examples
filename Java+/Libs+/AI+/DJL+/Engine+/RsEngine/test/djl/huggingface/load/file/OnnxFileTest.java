package djl.huggingface.load.file;
...
class OnnxFileTest {
    ...
    void byNewInstance() throws MalformedModelException, IOException, TranslateException {
        ...
        System.setProperty("ai.djl.default_engine", RsEngine.ENGINE_NAME);
        try (var model = Model.newInstance("msmarco-distilbert-base-tas-b.onnx")) {
            ...
            var translator = translatorFactory.newInstance(String.class, float[].class, model, Map.of());
