...
//        CellStyle style = row.getSheet().getWorkbook().createCellStyle();
    ...
    void merge() throws IOException {
        var file = Files.createTempFile(CellAlignmentTest.class.getSimpleName(), ".xls").toFile();
...
//            setAlignment(cellD1, HorizontalAlignment.DISTRIBUTED);
        ...
        try (var actWb = new XSSFWorkbook(new FileInputStream(file))) {
            ...
            assertThat(cellA1.getStringCellValue()).isEqualTo(valueA1);
            assertThat(cellB1.getStringCellValue()).isEqualTo(valueB1);
            assertThat(cellC1.getStringCellValue()).isEqualTo(valueC1);
            assertThat(cellD1.getStringCellValue()).isEqualTo(valueD1);
        }
    }
}
