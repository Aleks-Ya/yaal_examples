...
import azure.flow.authcode.common.HttpClientHelper;
...
class ApiHandler extends AbstractHandler {
    ...
    public void handle(String target, Request baseRequest, HttpServletRequest request, HttpServletResponse response)
        ...
        var apiAccessToken = HttpClientHelper.requestOboAccessToken(webAppClientId, webAppClientSecret, apiAppAuthority,
