...
public class FileStorageTest {
    ...
    void saveAuthorizationCode() {
        ...
        assertThat(storage.readAuthenticationCode(SESSION_ID_1)).isEqualTo(VALUE_1));

        assertNull(storage.readAuthenticationCode(SESSION_ID_2));
        storage.saveAuthorizationCode(SESSION_ID_2, VALUE_2);
        assertThat(storage.readAuthenticationCode(SESSION_ID_2)).isEqualTo(VALUE_2));
        assertThat(storage.readAuthenticationCode(SESSION_ID_1)).isEqualTo(VALUE_1));
    }
    ...
    void saveAccessToken() {
        ...
        assertThat(storage.readAccessToken(SESSION_ID_1)).isEqualTo(VALUE_1));

        assertNull(storage.readAccessToken(SESSION_ID_2));
        storage.saveAccessToken(SESSION_ID_2, VALUE_2);
        assertThat(storage.readAccessToken(SESSION_ID_2)).isEqualTo(VALUE_2));
        assertThat(storage.readAccessToken(SESSION_ID_1)).isEqualTo(VALUE_1));
    }
    ...
    void saveRefreshToken() {
        ...
        assertThat(storage.readRefreshToken(SESSION_ID_1)).isEqualTo(VALUE_1));

        assertNull(storage.readRefreshToken(SESSION_ID_2));
        storage.saveRefreshToken(SESSION_ID_2, VALUE_2);
        assertThat(storage.readRefreshToken(SESSION_ID_2)).isEqualTo(VALUE_2));
        assertThat(storage.readRefreshToken(SESSION_ID_1)).isEqualTo(VALUE_1));
    }
