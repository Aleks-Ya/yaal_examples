...
1. Create a function:
	...
	2. Function name: `kata-f-function-error-json`
	3. Runtime: `Python`
...
4. Test
	...
	2. Ivoke with CLI: 
		1. Invoke: `aws lambda invoke --function-name kata-f-function-error-json /tmp/function-error-json.json`
...
## Cleanup
1. Delete function `kata-f-function-error-json`
2. Delete Role `kata-f-function-error-json-role-`
