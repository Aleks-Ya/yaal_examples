...
def add_mw_menu_item(item_name: str, item_action: Callable) -> None:
    top_menu: QMenu = _create_top_menu(mw.form.menubar)
    addon_top_menu: QMenu = _create_addon_menu(top_menu, mw.form.menubar)
...
def _create_addon_menu(top_menu: QMenu, menubar: QMenuBar) -> QMenu:
...
def _add_item_to_edit_menu(item_name: str, item_action: Callable, browser: Browser) -> None:
    top_menu: QMenu = _create_top_menu(browser.form.menubar)
    addon_top_menu: QMenu = _create_addon_menu(top_menu, browser.form.menubar)
