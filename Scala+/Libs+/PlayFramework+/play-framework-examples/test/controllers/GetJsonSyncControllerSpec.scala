...
class GetJsonSyncControllerSpec extends PlaySpec with GuiceOneAppPerTest with Injecting {

  "ResponseJsonSyncController GET" should {
    "form JSON body from an object" in {
      val controller = new GetJsonSyncController(stubControllerComponents())
