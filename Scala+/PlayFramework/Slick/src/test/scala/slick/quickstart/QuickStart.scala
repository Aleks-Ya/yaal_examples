...
/**
 * Source: https://scala-slick.org/doc/3.3.3/gettingstarted.html
 */
class QuickStart extends AnyFlatSpec with Matchers {

  it should "run H2 database" in {
    val configFile = new File(getClass.getResource("application.conf").getFile)
