...
import akka.state.CurrencyCode.{CurrencyCode, EUR, RUR, USD}
import akka.state.CurrencyPrinterActor.PrintMessage
...
object CurrencyConverterActor {
  ...
  val rateMap = Map(RUR -> BigDecimal(1), USD -> BigDecimal(73.5), EUR -> BigDecimal(88.5))
