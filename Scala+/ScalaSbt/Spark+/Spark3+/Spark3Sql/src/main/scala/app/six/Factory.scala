...
object Factory {
  ...
  lazy val sellersDs: Dataset[Seller] = {
    val sellersParquet = "/media/aleks/ADATA/dataset/DatasetToCompleteTheSixSparkExercises/sellers_parquet"
  ...
  lazy val productsDs: Dataset[Product] = {
    val productsParquet = "/media/aleks/ADATA/dataset/DatasetToCompleteTheSixSparkExercises/products_parquet"
  ...
  lazy val salesDs: Dataset[Sale] = {
    val salesParquet = "/media/aleks/ADATA/dataset/DatasetToCompleteTheSixSparkExercises/sales_parquet"
