...
object Dependencies {
  ...
  val scalaMockDep = "org.scalamock" %% "scalamock" % "6.0.0" % Test
  val h2Dep = "com.h2database" % "h2" % "2.2.224"
  val logbackClassicDep = "ch.qos.logback" % "logback-classic" % "1.5.6"
  ...
  val catsEffectDep = "org.typelevel" %% "cats-effect" % "3.5.4"
  ...
  private val jacksonVersion = "2.17.2"
