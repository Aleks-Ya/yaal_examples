...
class StructTest extends AnyFlatSpec with SparkMatchers {
  ...
  it should "use struct function" in {
    ...
    updatedDf shouldHaveDDL "name STRING,details STRUCT<name: STRING, age: INT, gender: STRING> NOT NULL"
  ...
  it should "use when-otherwise in a struct function" in {
    ...
    updatedDf shouldHaveDDL "name STRING,age_info STRUCT<name: STRING, age_details: STRUCT<age: INT, category: STRING>> NOT NULL"
    updatedDf shouldContain(
  ...
  it should "use struct of lit(null)" in {
    ...
    updatedDf shouldHaveDDL "name STRING,details STRUCT<age: INT, empty: VOID, adultery: STRING> NOT NULL"
    updatedDf shouldContain(
