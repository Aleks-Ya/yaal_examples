...
## Build
1. Choose Java 11 version: `sdk use java 17.0.19-zulu`
2. Choose the Scala 2.13 version: `sdk use scala 2.13.18`
3. Choose the latest SBT version: `sdk use sbt 1.12.11`
