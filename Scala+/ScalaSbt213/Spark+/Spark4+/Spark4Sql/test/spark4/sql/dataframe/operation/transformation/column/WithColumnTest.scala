...
class WithColumnTest extends AnyFlatSpec with SparkMatchers {
  ...
  it should "add a constant column" in {
    ...
    updatedDf shouldHaveDDL "name STRING,age INT,gender STRING,text STRING NOT NULL,number INT NOT NULL"
  ...
  it should "add a constant column with null value" in {
    ...
    updatedDf shouldHaveDDL "name STRING,age INT,gender STRING,text STRING,number INT"
    updatedDf shouldContain(
  ...
  it should "add an index column" in {
    ...
    updatedDf shouldHaveDDL "name STRING,age INT,gender STRING,index BIGINT NOT NULL"
    updatedDf shouldContain(
  ...
  it should "add a column based on another column" in {
    ...
    updatedDf shouldHaveDDL "name STRING,age INT,gender STRING,double_age INT"
    updatedDf shouldContain(
  ...
  it should "add a column based on other columns" in {
    ...
    updatedDf shouldHaveDDL "name STRING,age INT,gender STRING,gender_age STRING NOT NULL"
    updatedDf shouldContain(
  ...
  it should "cast another column data type" in {
    ...
    updatedDf shouldHaveDDL "name STRING,age INT,gender STRING,age_str STRING"
    updatedDf shouldContain(
  ...
  it should "use added column in another added column" in {
    ...
    updatedDf shouldHaveDDL "name STRING,age INT,gender STRING,text STRING NOT NULL,text_upper STRING NOT NULL"
    updatedDf shouldContain(
