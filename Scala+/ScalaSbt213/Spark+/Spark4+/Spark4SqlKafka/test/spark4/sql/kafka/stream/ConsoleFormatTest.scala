package spark4.sql.kafka.stream

import io.github.embeddedkafka.EmbeddedKafka
import org.apache.kafka.common.serialization.StringSerializer
import org.scalatest.flatspec.AnyFlatSpec
import org.scalatest.matchers.should.Matchers
import spark4.sql.kafka.Factory


class ConsoleFormatTest extends AnyFlatSpec with EmbeddedKafka with Matchers {

  it should "log messages to console" in {
    withRunningKafka {
      val topic = "topic1"
